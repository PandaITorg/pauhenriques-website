    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-5 animated-linear-gradient-links text-text-main">
      <div className="w-full max-w-md text-center">
        ...
        <div className="flex flex-col gap-4">
          ...
          <Link
            to="/tienda"
            className="bg-secondary text-text-dark font-bold py-3 px-8 rounded-full block transition-all duration-300 ease-in-out hover:brightness-110 hover:scale-110 active:scale-95 transform"
          >
            Visita la tienda en linea
          </Link>
          */}
        </div>
      </div>
