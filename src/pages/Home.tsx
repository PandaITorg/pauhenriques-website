        ...
        <section className="relative h-full flex items-end">
          ...
          <div className="relative container mx-auto px-4 z-40 flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <div className="w-full md:w-1/2 text-center md:text-left flex-grow pt-8 pb-8 md:pb-12">
              ...
              >
                Ingeniera comercial experta en salud integral con
                certificaciones en Nutrición, anti-aging y vida sin tóxicos.
              </p>
              <div
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-12">
                ...
                <p className="text-lg text-text-secondary leading-relaxed">
                  ...
                  cómo poder sanar mi cuerpo de adentro para afuera. En como
                  vivir un estilo de vida libre de tóxicos.
                </p>

                <p className="text-lg text-text-secondary leading-relaxed">
                  Actualmente trabajo junto a mi compañero de vida y esposo
