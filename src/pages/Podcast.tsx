  ...
  const episodes = [
    {
      ...
      description: "En este episodio te cuento como el sistema de descanso con conexión a tierra ha ayudado a mi familia en su descanso. Es un testimonio personal que la crisis de sueño que existían en mi familia y que gracias al Earthing lo hemos superado. Te invito a escucharlo y si te sientes identificada sepas que no estás sola y que existe un sistema que te puede ayudar de forma natural. Compártelo si conoces personas que tengan crisis de sueño y/o insomnio. Pau",
      spotifyLink: "https://open.spotify.com/episode/6eMZqxyHUtW46yJd0Et4uw", // Placeholder, actual link not found
      applePodcastLink: "https://podcasts.apple.com/us/podcast/de-t%C3%B3xica-a-sin-t%C3%B3xicos/id1567244331", // Updated to main show link
    },
    {
      id: 2,
      title: "EPISODIO #10: EL VENENO SILENCIOSO QUE TE ESTÁS COMIENDO TODOS LOS DÍAS",
      description: "Episodio 10 ! wow! Que emoción que compartas conmigo este espacio! En esta ocasión mi esposo me va a acompañar ya que es un tema un poco mmm \"espeso\" y necesitaba conversarlo o contárselo a alguien. Luego de mucha investigación tengo información que te va a convencer al 100% de ir a tu cocina y botar todas las sartenes y ollas de teflón que tengas para de una buena vez eliminarlo de tu vida. El Teflón nos envenena es un FACT! Cuéntame si fue clara o clarísima!",
      spotifyLink: "https://open.spotify.com/episode/6eMZqxyHUtW46yJd0Et4uw", // Placeholder, actual link not found
      applePodcastLink: "https://podcasts.apple.com/us/podcast/de-t%C3%B3xica-a-sin-t%C3%B3xicos/id1567244331", // Updated to main show link
    },
    {
      id: 3,
      title: "EPISODIO # 9 : CONOCE LOS BIORRITMOS DE TU CUERPO Y APLÍCALOS A TU FAVOR!",
      description: "Hola , bienvenida/o nuevamente a este espacio, estoy feliz de compartirlo contigo . En este episodio te cuento sobre los biorritmos del cuerpo, cuántos tenemos y cómo utilizarlos a nuestro favor para : tener una mejor digestión , tener más energía y si nuestra meta es bajar de peso, bueno pues sí para bajarlo! Cuéntame si esta información para tí tiene lógica y si la implementas, cuéntame como te va! Sígueme en instagram como pau_henriques para más información sobre salud integral. Te espero por allá un abrazo Pau",
      spotifyLink: "https://open.spotify.com/episode/6eMZqxyHUtW46yJd0Et4uw", // Placeholder, actual link not found
      applePodcastLink: "https://podcasts.apple.com/us/podcast/de-t%C3%B3xica-a-sin-t%C3%B3xicos/id1567244331", // Updated to main show link
    },
  ];
        ...
        <section className="flex flex-col md:flex-row items-center justify-center gap-8 mb-12 p-6 bg-white rounded-lg shadow-lg">
          ...
          <div className="md:w-2/3 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-4">
              <a
                href="https://open.spotify.com/show/6eMZqxyHUtW46yJd0Et4uw" // Placeholder for Spotify link
                target="_blank"
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {episodes.map((episode) => (
              <div key={episode.id} className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
                <h3 className="text-xl font-semibold mb-2 text-[#343d2a]">{episode.title}</h3>
