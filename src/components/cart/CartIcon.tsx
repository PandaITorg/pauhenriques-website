...
import React, { useEffect, useState } from 'react'; // <-- Importación de React añadida
...
const CartIcon = () => {
  ...
  return (
    <Link href="/checkout" className="relative flex items-center text-text-main hover:text-[#5a6b4a] transition-colors">
