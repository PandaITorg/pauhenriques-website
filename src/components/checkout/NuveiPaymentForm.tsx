...
const NuveiPaymentForm: React.FC<NuveiPaymentFormProps> = ({ onTokenSuccess, onTokenError }) => {
  ...
  useEffect(() => {
    ...
    script.src = 'https://cdn.paymentez.com/ccapi/sdk/staging/v2/paymentez.min.js'; // Staging URL
    script.async = true;
  ...
  return (
    <form id="add-card-form" onSubmit={handleSubmit} className="space-y-4">
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">Nombre del Tarjetahabiente</label>
        <div id="card-holder-name-container" className="p-3 border border-gray-300 rounded-md shadow-sm"></div>
      </div>
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">Número de Tarjeta</label>
        <div id="card-number-container" className="p-3 border border-gray-300 rounded-md shadow-sm"></div>
      </div>
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Fecha de Expiración</label>
          <div id="card-expiry-container" className="p-3 border border-gray-300 rounded-md shadow-sm"></div>
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">CVC</label>
          <div id="card-cvc-container" className="p-3 border border-gray-300 rounded-md shadow-sm"></div>
        </div>
      </div>
