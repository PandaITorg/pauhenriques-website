...
2.  Pide confirmación: _"¿Te parece bien el plan? Dime 'Adelante'."_
...
3.  Pregunta: _"¿Listo para el siguiente paso?"_
...
Esta es la documentación oficial del proyecto. Cada archivo cubre un propósito específico:

| Archivo                                                                | Propósito                                                                        | Audiencia                                              |
| ---------------------------------------------------------------------- | -------------------------------------------------------------------------------- | ------------------------------------------------------ |
| [`README.md`](README.md)                                               | Visión general, tech stack, protocolos de desarrollo y modos de operación        | Todos (desarrolladores, diseñadores, SEO, legal)       |
| [`docs/firebase-app-hosting-env.md`](docs/firebase-app-hosting-env.md) | Gestión de variables de entorno en Firebase App Hosting con Cloud Secret Manager | DevOps/Desarrolladores de configuración                |
| [`docs/google-auth-setup.md`](docs/google-auth-setup.md)               | Guía paso a paso para configurar Google Sign-In en Firebase Console              | Desarrolladores que configuran autenticación           |
| [`docs/setup-secrets.md`](docs/setup-secrets.md)                       | Creación y gestión de secretos en Cloud Secret Manager                           | DevOps/Desarrolladores de infraestructura de seguridad |
| [`docs/auth-registration-flow.md`](docs/auth-registration-flow.md)     | Blueprint de implementación del flujo de registro y login                        | Desarrolladores que implementan la feature             |

### 🔗 Referencias Cruzadas

- Para entender **cómo se usan las variables** en App Hosting → ver [`docs/firebase-app-hosting-env.md`](docs/firebase-app-hosting-env.md)
- Para **crear los secretos** en Cloud Secret Manager → ver [`docs/setup-secrets.md`](docs/setup-secrets.md)
- Para **configurar Google Sign-In** en Firebase Console → ver [`docs/google-auth-setup.md`](docs/google-auth-setup.md)
- Para **implementar el flujo de autenticación** → ver [`docs/auth-registration-flow.md`](docs/auth-registration-flow.md) (requiere haber configurado Google Sign-In primero)
...
1. [ ] Configurar variables de entorno (ver [`docs/firebase-app-hosting-env.md`](docs/firebase-app-hosting-env.md))
2. [ ] Crear secretos en Cloud Secret Manager (ver [`docs/setup-secrets.md`](docs/setup-secrets.md))
3. [ ] Configurar Google Sign-In (ver [`docs/google-auth-setup.md`](docs/google-auth-setup.md))
4. [ ] Desplegar Firestore Security Rules
5. [ ] Verificar que Google Sign-In funciona localmente
6. [ ] Realizar primer deploy: `firebase deploy --only hosting`
